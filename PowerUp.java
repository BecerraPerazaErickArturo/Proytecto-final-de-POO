...
public class PowerUp extends MovingObject{
	...
	public void draw(Graphics g){
		...
		at = AffineTransform.getTranslateInstance(position.getX() + Assets.orb.getWidth()/2 - typeTexture.getWidth()/2, position.getY() + Assets.orb.getHeight()/2 - typeTexture.getHeight()/2);
