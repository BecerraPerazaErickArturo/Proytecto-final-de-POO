...
public class Player extends MovingObject{
	...
	public void draw(Graphics g){
		...
		if(shieldOn){
			...
			AffineTransform at3 = AffineTransform.getTranslateInstance(position.getX() - currentFrame.getWidth() / 2 + width/2, position.getY() - currentFrame.getHeight() / 2 + height/2);
